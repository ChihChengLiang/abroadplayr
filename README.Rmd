...
這個套件旨在降低分析公務出國考察報告的門檻，讓資料分析者能夠略過爬蟲、清理資料，直接進入視覺化與統計分析。套件包含最重要 [公務出國報告查詢統計網](http://report.nat.gov.tw/ReportFront/index.jspx) 中所使用的資料集，係由公務出國考察統計網團隊從中央與各地方政府的網站爬得的公務考察報告。以下是資料集概要： 
